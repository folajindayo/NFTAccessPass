...
export interface NFTAccessPassInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "balanceOf"
...
export interface NFTAccessPass extends BaseContract {
  connect(runner?: ContractRunner | null): NFTAccessPass;
  waitForDeployment(): Promise<this>;

  interface: NFTAccessPassInterface;
